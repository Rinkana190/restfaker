...
async function basicCall(url: string, query: Object) {
  return await fetch(url, query).then(parseResponse).catch(data => {
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4">
            ...
            <div className="row" style={{ marginTop: 20 }}>
              <h2 style={{ marginBottom: 5 }}>Scheme</h2>
              {
          ...
          <div className="col-md-8">
            <h2 style={{ marginBottom: 5 }}>Request</h2>
            <div className="row">
